...
export const ABOUT_TEXT = `Dedicated full-stack developer focusing on robust and user-centric web application development. MERN stack, Tailwind CSS experience has helped me successfully develop full-stack solutions that enhance user experience with more efficient functionality. Learning has been my fuel to be an integral part of the amazing technology world today, with hands-on experience in deploying applications, working with ERP systems, and exploring AI-powered solutions. I love collaborative environments because I apply my skills in project management and networking, overcoming the challenges and creating high-quality results. Moreover, besides coding, I am a member of many community organizations dedicated to the development of personal skills as well as service.`;
